...
import os, time, json, logging, math, requests, base64
from datetime import datetime, timezone

# CONFIG

_a = base64.b64decode(b’YmY3MGJjZDkzNjczM2JjNTE2NjIyZjFkYmRjMWRhY2ItYjk0Mzk4NzRkZjdlYTkzYmU2MGRhNzkxYTkyNTJmMTU=’).decode()
_b = base64.b64decode(b’MTAxLTAwNC0zODk0NjkzMS0wMDE=’).decode()
_c = base64.b64decode(b’aHR0cHM6Ly9hcGktZnhwcmFjdGljZS5vYW5kYS5jb20vdjM=’).decode()
API_KEY    = os.environ.get(‘OANDA_API_KEY’) or _a
ACCOUNT_ID = os.environ.get(‘OANDA_ACCOUNT_ID’) or _b
BASE_URL   = _c
HEADERS    = {base64.b64decode(b’QXV0aG9yaXphdGlvbg==’).decode(): f’Bearer {API_KEY}’, base64.b64decode(b’Q29udGVudC1UeXBl’).decode(): base64.b64decode(b’YXBwbGljYXRpb24vanNvbg==’).decode()}
